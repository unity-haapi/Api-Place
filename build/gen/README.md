...
*PlaceApi* | [**addNewPlace**](docs/PlaceApi.md#addNewPlace) | **POST** /place | Add new place
*PlaceApi* | [**addNewPlaceWithHttpInfo**](docs/PlaceApi.md#addNewPlaceWithHttpInfo) | **POST** /place | Add new place
*PlaceApi* | [**createEventParticipant**](docs/PlaceApi.md#createEventParticipant) | **POST** /events/{event_id}/participants | Create eventParticipant
*PlaceApi* | [**createEventParticipantWithHttpInfo**](docs/PlaceApi.md#createEventParticipantWithHttpInfo) | **POST** /events/{event_id}/participants | Create eventParticipant
*PlaceApi* | [**createOrupdateEvents**](docs/PlaceApi.md#createOrupdateEvents) | **PUT** /events | Create new or update existing events
*PlaceApi* | [**createOrupdateEventsWithHttpInfo**](docs/PlaceApi.md#createOrupdateEventsWithHttpInfo) | **PUT** /events | Create new or update existing events
*PlaceApi* | [**deleteEvent**](docs/PlaceApi.md#deleteEvent) | **DELETE** /events/{id} | Delete event by identifier
*PlaceApi* | [**deleteEventWithHttpInfo**](docs/PlaceApi.md#deleteEventWithHttpInfo) | **DELETE** /events/{id} | Delete event by identifier
*PlaceApi* | [**getEventById**](docs/PlaceApi.md#getEventById) | **GET** /events/{id} | Get event by identifier
*PlaceApi* | [**getEventByIdWithHttpInfo**](docs/PlaceApi.md#getEventByIdWithHttpInfo) | **GET** /events/{id} | Get event by identifier
*PlaceApi* | [**getEvents**](docs/PlaceApi.md#getEvents) | **GET** /events | Get all events
*PlaceApi* | [**getEventsWithHttpInfo**](docs/PlaceApi.md#getEventsWithHttpInfo) | **GET** /events | Get all events
*PlaceApi* | [**getParticipants**](docs/PlaceApi.md#getParticipants) | **GET** /events/{event_id}/participants | Get all participants of a specific event
